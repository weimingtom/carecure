...
procedure Tfrm_GoodsCheckIn.FormShow(Sender: TObject);
begin
  DMod.tcr.Close;
  DMod.tcr.Open;
...
procedure Tfrm_GoodsCheckIn.DBGridEh1ColExit(Sender: TObject);
begin
...
function Tfrm_GoodsCheckIn.check: boolean;
begin
  result:=true;
...
procedure Tfrm_GoodsCheckIn.saveClick(Sender: TObject);
begin
...
procedure Tfrm_GoodsCheckIn.retClick(Sender: TObject);
begin
...
procedure Tfrm_GoodsCheckIn.FormClose(Sender: TObject; var Action: TCloseAction);
begin
try
...
procedure Tfrm_GoodsCheckIn.DBGridEh1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tfrm_GoodsCheckIn.BitBtn3Click(Sender: TObject);
begin
close;
end;
