...
var
  frm_SalesProfit: Tfrm_SalesProfit;
...
procedure Tfrm_SalesProfit.BitBtn5Click(Sender: TObject);
begin
...
procedure Tfrm_SalesProfit.SpeedButton2Click(Sender: TObject);
...
procedure Tfrm_SalesProfit.SpeedButton4Click(Sender: TObject);
var sqlstr,wherestr:string;
begin
...
procedure Tfrm_SalesProfit.SpeedButton3Click(Sender: TObject);
var sqlstr,wherestr:string;
begin
...
procedure Tfrm_SalesProfit.SpeedButton1Click(Sender: TObject);
var sqlstr,wherestr:string;
begin
...
procedure Tfrm_SalesProfit.BitBtn3Click(Sender: TObject);
begin
close;
end;

procedure Tfrm_SalesProfit.FormClose(Sender: TObject; var Action: TCloseAction);
begin
DMod.txstj.Close;
action:=cafree;
end;

procedure Tfrm_SalesProfit.FormShow(Sender: TObject);
begin
  DMod.txstj.Close;
