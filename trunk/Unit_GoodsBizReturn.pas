...
type
  Tfrm_GoodsBizReturn = class(TForm)
    DBGridEh1: TDBGridEh;
    Label1: TLabel;
...
procedure Tfrm_GoodsBizReturn.FormShow(Sender: TObject);
begin
  DMod.tcr.Close;
  DMod.tcr.Open;
...
procedure Tfrm_GoodsBizReturn.DBGridEh1ColExit(Sender: TObject);
begin
...
function Tfrm_GoodsBizReturn.check: boolean;
begin
  result:=true;
...
procedure Tfrm_GoodsBizReturn.saveClick(Sender: TObject);
begin
...
procedure Tfrm_GoodsBizReturn.retClick(Sender: TObject);
begin
...
procedure Tfrm_GoodsBizReturn.FormClose(Sender: TObject; var Action: TCloseAction);
begin
try
...
procedure Tfrm_GoodsBizReturn.DBGridEh1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tfrm_GoodsBizReturn.BitBtn3Click(Sender: TObject);
begin
close;
end;
