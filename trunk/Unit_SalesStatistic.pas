...
type
  Tfrm_SalesStatistic = class(TForm)
    Label1: TLabel;
...
var
  frm_SalesStatistic: Tfrm_SalesStatistic;

implementation

{$R *.dfm}

procedure Tfrm_SalesStatistic.FormShow(Sender: TObject);
begin
  label3.Caption:=datetimetostr(date);
  DMod.ttemp.Close;
end;

procedure Tfrm_SalesStatistic.BitBtn5Click(Sender: TObject);
...
procedure Tfrm_SalesStatistic.printClick(Sender: TObject);
begin
...
procedure Tfrm_SalesStatistic.BitBtn3Click(Sender: TObject);
begin
close;
end;

procedure Tfrm_SalesStatistic.FormClose(Sender: TObject; var Action: TCloseAction);
begin
DMod.tcrlist.Close;
action:=cafree;
end;
