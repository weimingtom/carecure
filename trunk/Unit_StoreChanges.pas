...
uses
  ...
  ExtCtrls, PrnDbgeh,Unit_DataModule, Mask, GridsEh;

type
  Tfrm_StoreChanges = class(TForm)
...
var
  frm_StoreChanges: Tfrm_StoreChanges;

implementation

{$R *.dfm}

procedure Tfrm_StoreChanges.BitBtn5Click(Sender: TObject);
...
procedure Tfrm_StoreChanges.BitBtn3Click(Sender: TObject);
begin
close;
end;

procedure Tfrm_StoreChanges.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  DMod.ttemp.Close;
  DMod.tcrlist.Close;
  action:=cafree;
...
procedure Tfrm_StoreChanges.FormShow(Sender: TObject);
begin
DMod.ttemp.Close;
  DMod.tcrlist.Close;
end;

procedure Tfrm_StoreChanges.BitBtn1Click(Sender: TObject);
begin
